...
Este é um projeto de transações bancárias desenvolvido em Python utilizando Programação Estruturada. O sistema permite realizar saques e depósitos, com verificação de saldo, um limite de 10 transações diárias e a exibição de extratos organizados por tipo de operação.
